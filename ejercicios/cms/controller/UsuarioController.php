...
class UsuarioController
{
        ...
        //Si ha pulsado el botón de acceder, tramito el formulario
            ...
            if ($usuario){
                ...
                if (password_verify($campo_clave,$usuario->clave)) {
                    ...
                    $_SESSION["partidas"] = $usuario->noticias;
    ...
    public function editar($id){
        ...
        if (isset($_POST["guardar"])){
            ...
            $noticias = (filter_input(INPUT_POST, 'partidas', FILTER_SANITIZE_STRING) == 'on') ? 1 : 0;
            ...
            if ($id == "nuevo"){
                ...
                $this->db->exec("INSERT INTO usuarios (usuario, clave, partidas, usuarios) VALUES ('$usuario','$clave_encriptada',$noticias,$usuarios)");
                ...
                ($cambiar_clave) ?
                    $this->db->exec("UPDATE usuarios SET usuario='$usuario',clave='$clave_encriptada',partidas=$noticias,usuarios=$usuarios WHERE id='$id'") :
                    $this->db->exec("UPDATE usuarios SET usuario='$usuario',partidas=$noticias,usuarios=$usuarios WHERE id='$id'");
