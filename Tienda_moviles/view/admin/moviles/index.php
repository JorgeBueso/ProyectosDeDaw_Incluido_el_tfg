            ...
            <div class="card horizontal  sticky-action admin">
                <div class="card-stacked">
                    ...
                    <div class="card-action">
                        ...
                        <a href="<?php echo $_SESSION['home']."admin/moviles/activar/".$row->id ?>" title="<?php echo $title ?>">
                        ...
                        <a href="<?php echo $_SESSION['home']."admin/moviles/home/".$row->id ?>" title="<?php echo $title ?>">
                ...
                <div class="card-reveal">
                    <span class="card-title grey-text text-darken-4">Borrar movil<i class="material-icons right">close</i></span>
                    <p>
                        ¿Está seguro de que quiere borrar el movil<strong><?php echo $row->modelo ?></strong>?<br>
