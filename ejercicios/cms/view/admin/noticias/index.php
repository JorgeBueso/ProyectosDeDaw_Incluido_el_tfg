        ...
        <div class="card horizontal admin">
            <div class="card-stacked">
                ...
                <div class="card-action">
                    <a href="<?php echo $_SESSION['home']."admin/partidas/crear" ?>" title="Añadir nueva noticia">
        ...
        <article class="col s12 l6">
            <div class="card horizontal  sticky-action admin">
                <div class="card-stacked">
                    ...
                    <div class="card-action">
                        <a href="<?php echo $_SESSION['home']."admin/partidas/editar/".$row->id ?>" title="Editar">
                        ...
                        <a href="<?php echo $_SESSION['home']."admin/partidas/activar/".$row->id ?>" title="<?php echo $title ?>">
                        ...
                        <a href="<?php echo $_SESSION['home']."admin/partidas/home/".$row->id ?>" title="<?php echo $title ?>">
                ...
                <div class="card-reveal">
                    ...
                    <a href="<?php echo $_SESSION['home']."admin/partidas/borrar/".$row->id ?>" title="Borrar">
