        ...
        //Si ha pulsado el botón de acceder, tramito el formulario
            ...
            if ($usuario){
                ...
                if (password_verify($campo_clave,$usuario->clave)) {
                    ...
                    $_SESSION["mascotas"] = $usuario->mascotas;
...
//                $this->db->exec("INSERT INTO usuarios (usuario, clave, usuarios) VALUES ('$usuario','$clave_encriptada',$usuarios)");
//
//                //Mensaje y redirección
...
//                ($cambiar_clave) ?
//                    $this->db->exec("UPDATE usuarios SET usuario='$usuario',clave='$clave_encriptada',usuarios=$usuarios WHERE id='$id'") :
//                    $this->db->exec("UPDATE usuarios SET usuario='$usuario',usuarios=$usuarios WHERE id='$id'");
//
//                //Mensaje y redirección
