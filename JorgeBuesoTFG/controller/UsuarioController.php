...
//////////////////////////////////////////////////////////-----------------------------------------------------------///////////////////////////////////////
    ...
    public function crearUsuarioConAdmin(){
    ...
    public function editarUsuario($id){
        ...
        if (isset($_POST["guardar"])){
            ...
            if ($id == "nuevo"){
                ...
                ($cambiar_clave) ?
                    $this->db->exec("UPDATE usuarios SET usuario='$usuario',clave='$clave_encriptada',accesorios=$accesorios,usuarios=$usuarios WHERE id='$id'") :
                    $this->db->exec("UPDATE usuarios SET usuario='$usuario',accesorios=$accesorios,usuarios=$usuarios WHERE id='$id'");
