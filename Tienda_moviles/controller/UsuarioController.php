...
class UsuarioController
{
        ...
        //Si ha pulsado el botón de acceder, tramito el formulario
            ...
            if ($usuario){
                ...
                if (password_verify($campo_clave,$usuario->clave)) {
                    ...
                    $_SESSION["moviles"] = $usuario->moviles;
    ...
    public function editar($id){
        ...
        if (isset($_POST["guardar"])){
            ...
            $moviles = (filter_input(INPUT_POST, 'moviles', FILTER_SANITIZE_STRING) == 'on') ? 1 : 0;
            ...
            if ($id == "nuevo"){
                ...
                ($cambiar_clave) ?
                    $this->db->exec("UPDATE usuarios SET usuario='$usuario',clave='$clave_encriptada',moviles=$moviles,usuarios=$usuarios WHERE id='$id'") :
